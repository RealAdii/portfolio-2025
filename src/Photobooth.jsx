      ...
      <main className="main">
        ...
        <div className="content">
          ...
          <div className="photo-item photo-item-small">
            <img src="/firstpod.png" alt="photo 1" className="photobooth-image" />
            <p className="photo-caption">podcast w/ nader</p>
          </div>
          
          <div className="photo-item photo-item-medium">
            <img src="/solanahackerhouse.png" alt="photo 2" className="photobooth-image photobooth-image-contain" />
            <p className="photo-caption">speaker at solana hacker house</p>
          </div>
          
          <div className="photo-item photo-item-large">
            <img src="/zo.png" alt="photo 3" className="photobooth-image" />
            <p className="photo-caption">technical session at zo world</p>
          </div>
          
          <div className="photo-item photo-item-small">
            <img src="/hashedhouse.png" alt="photo 4" className="photobooth-image" />
            <p className="photo-caption">speaker at hashed house</p>
          </div>
          
          <div className="photo-item photo-item-wide">
            <img src="/college.png" alt="photo 5" className="photobooth-image photobooth-image-contain" />
            <p className="photo-caption">got called back to college</p>
          </div>
          
          <div className="photo-item photo-item-medium">
            <img src="/chennai.png" alt="photo 6" className="photobooth-image" />
            <p className="photo-caption">regular size</p>
          </div>

          <div className="photo-item photo-item-small">
            <img src="/singapore.JPG" alt="singapore" className="photobooth-image" />
            <p className="photo-caption">Token2049 had my first IRL close</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/devconnect.JPG" alt="devconnect" className="photobooth-image" />
            <p className="photo-caption">i walked around with a whiteboard screaming zktls</p>
          </div>

          <div className="photo-item photo-item-small">
            <img src="/communitysesh.jpeg" alt="community session" className="photobooth-image" />
            <p className="photo-caption">community session</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/harsha.JPG" alt="harsha" className="photobooth-image photobooth-image-contain" />
            <p className="photo-caption">harsha, who i've learned a lot from</p>
          </div>
          
          <div className="photo-item photo-item-small">
            <img src="/IITdelhi.jpg" alt="photo 7" className="photobooth-image" />
          ...
          <div className="photo-item photo-item-tall">
            <img src="/dubai.JPG" alt="photo 8" className="photobooth-image" />
            <p className="photo-caption">sales repping in dubai</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/GFF.JPG" alt="photo 9" className="photobooth-image" />
            <p className="photo-caption">web2 sales because we hit the ceiling in web3</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/oktooffice.png" alt="photo 9" className="photobooth-image" />
            <p className="photo-caption">fun ad shot at the coinDCX office for questbook!</p>
          </div>

          <div className="photo-item photo-item-wide">
            <img src="/40folkswhiteboarding.png" alt="whiteboarding event" className="photobooth-image" />
            <p className="photo-caption">packed 30+ folks in an airbnb and did a whiteboarding session</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/delhi.png" alt="delhi" className="photobooth-image" />
            <p className="photo-caption">live coding session admist 400AQI</p>
          </div>

          <div className="photo-item photo-item-small">
            <img src="/solanablr.png" alt="solana blur" className="photobooth-image" />
            <p className="photo-caption">got called back again to solana DEPIN summit</p>
          </div>

          <div className="photo-item photo-item-medium">
            <img src="/merch.png" alt="merch" className="photobooth-image photobooth-image-contain" />
